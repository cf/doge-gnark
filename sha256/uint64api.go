/*
Originally from https://github.com/celer-network/brevis-circuits/

There was no license (other than "ALL RIGHTS RESERVED") but wanted to give them a shoutout for sha256 without a LUT (which messes up our proof format by adding a commitment wire)
*/
